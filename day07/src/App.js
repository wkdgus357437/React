...
const App = () => {
  return (
    <div>
      {/* npm install react-router-dom,  yarn add axios 다운 */}

      {/* <App01/>  */}
      {/* folder: page01, BrowserRouter, Link,  folder: page01*/}
      
      {/* <App02/> */}
       {/* , folder: page02, css: style02.css */}

      {/* <App03/> */}
      {/* folder: page03, useParams */}

      {/* <App04/> */}
      {/* BrowserRouter, axios, folder: page04,  */}

      <App05/>
      {/* folder: page05, css: style05.css */}
